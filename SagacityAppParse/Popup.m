...
CGFloat popupDimensionWidth = 280.0f;
...
- (void)makeAlertPopupView {
    ...
    [popupView.layer setCornerRadius:10.0f];
    [popupView.layer setBorderColor:[UIColor lightGrayColor].CGColor];
    [popupView.layer setBorderWidth:1.0f];
...
- (void)setupTitle {
    ...
    if (pTitle) {
        if (!titleLabel) {
            titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.bounds.size.width-90, 32.0f)];
            titleLabel.backgroundColor=[UIColor colorWithHexString:color];
            ...
            [titleLabel setTextColor:[UIColor whiteColor] /*#546595*/];
        }
